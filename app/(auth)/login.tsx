        ...
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={s.roles}>
            {ROLES.map(r => (
              <TouchableOpacity
                key={r.key}
                style={[s.roleBtn, role === r.key && { backgroundColor: r.color, borderColor: r.color }]}
...
const s = StyleSheet.create({
  ...
  roleBtn: { flex: 1, alignItems: "center", paddingVertical: 12, borderRadius: Radius.md, borderWidth: 1.5, borderColor: Colors.border, backgroundColor: Colors.card, gap: 4 },
