      ...
      >
        <View style={s.header}>
          ...
          <View style={s.condBadge}>
            <Text style={s.condText}>{plan.condition}</Text>
          </View>
        </View>
        <Text style={s.sub}>
          Personalized based on your diagnosis{patient?.diagnosis ? `: ${patient.diagnosis}` : "."}
        </Text>
        ...
        <View style={s.noteCard}>
          <Text style={s.noteText}>
            ℹ️ This is a general guideline. Your nurse may customize this plan further based on your specific needs.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
